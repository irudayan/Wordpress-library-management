    ...
    <div class="tab-sec">
		...
		<div id="product_addons_editor" class="tabcontent product_woo_tab">
			<?php if(!is_plugin_active('ibtana-ecommerce-product-addons/plugin.php')){ 
				...
				<div class="vw-book-store-recommended-plugins">
			    	<div class="vw-book-store-action-list">
                	<div class="vw-book-store-action" id="<?php echo esc_attr($vw_book_store_actions['id']);?>">
                     <div class="action-inner plugin-activation-redirect">
                        <h3 class="action-title"><?php echo esc_html($vw_book_store_actions['title']); ?></h3>
                        <div class="action-desc"><?php echo esc_html($vw_book_store_actions['desc']); ?>
                        </div>
                        <?php echo wp_kses_post($vw_book_store_actions['link']); ?>
                     </div>
                	</div>
			    	</div>
				</div>
			<?php }else{ ?>
				...
				<hr class="h3hr">
	              	<div class="vw-book-store-pattern-page">
				    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates&woo=true' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vw-book-store'); ?></a>
				    	</div>
			    </div>
			<?php } ?>
		</div>
