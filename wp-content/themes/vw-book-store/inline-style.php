<?php
	...
	if($vw_book_store_second_color != false){
		$vw_book_store_custom_css .='.search-box i, .top-bar .custom-social-icons i:hover, .post-main-box h3 a, .entry-content a, .main-navigation .current_page_item > a, .main-navigation .current-menu-item > a, .main-navigation a:hover, .post-main-box h2 a, h2.section-title a, #footer .textwidget a, .logo .site-title a:hover{';
	...
	if($vw_book_store_copyright_alingment != false){
		$vw_book_store_custom_css .='.copyright p{';
			$vw_book_store_custom_css .='text-align: '.esc_attr($vw_book_store_copyright_alingment).';';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_products_border_radius = get_theme_mod('vw_book_store_products_border_radius');
