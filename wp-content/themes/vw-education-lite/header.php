...
<header role="banner">
  ...
  <?php if( get_theme_mod( 'vw_education_lite_topbar_hide_show', false) != '' || get_theme_mod( 'vw_education_lite_resp_topbar_hide_show', false) != '') { ?>
    <div class="top-bar">
    	<div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-3 phone">
            <?php if(get_theme_mod('vw_education_lite_cont_phone','') != '') { ?>
              <i class="<?php echo esc_attr(get_theme_mod('vw_education_lite_cont_phone_icon','fas fa-mobile-alt')); ?>"></i><span><a href="tel:<?php echo esc_attr( get_theme_mod('vw_education_lite_cont_phone','') ); ?>"><?php echo esc_html(get_theme_mod('vw_education_lite_cont_phone',''));?></a></span>
            <?php } ?>
          </div>		
      		<div class="col-lg-3 col-md-4 phone">
            <?php if(get_theme_mod('vw_education_lite_cont_email','') != '') { ?>
              <i class="<?php echo esc_attr(get_theme_mod('vw_education_lite_cont_email_icon','far fa-envelope')); ?>"></i><span><a href="mailto:<?php echo esc_attr(get_theme_mod('vw_education_lite_cont_email',''));?>"><?php echo esc_html(get_theme_mod('vw_education_lite_cont_email',''));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('vw_education_lite_cont_email','')); ?></span></a></span>
            <?php } ?>
          </div>
  ...
  <?php }?>
    <div class="header">
      <div class="header-menu <?php if( get_theme_mod( 'vw_education_lite_sticky_header', false) != '' || get_theme_mod( 'vw_education_lite_stickyheader_hide_show', false) != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
        <div class="row m-0">
...
<?php if(get_theme_mod('vw_education_lite_loader_enable',false) != '') { ?>
  <div id="preloader">
