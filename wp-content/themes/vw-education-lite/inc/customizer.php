...
function vw_education_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_education_lite_preloader_bg_color', array(
		'default'           => '#99ce34',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_education_lite_preloader_bg_color', array(
		'label'    => __('Pre-Loader Background Color', 'vw-education-lite'),
		'section'  => 'vw_education_lite_left_right',
	)));

	$wp_customize->add_setting('vw_education_lite_preloader_border_color', array(
		'default'           => '#ffffff',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_education_lite_preloader_border_color', array(
		'label'    => __('Pre-Loader Border Color', 'vw-education-lite'),
		'section'  => 'vw_education_lite_left_right',
	)));
    ...
    $wp_customize->add_setting( 'vw_education_lite_toggle_time',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_education_lite_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Education_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_education_lite_toggle_time',array(
		'label' => esc_html__( 'Time','vw-education-lite' ),
		'section' => 'vw_education_lite_post_settings'
    )));
	...
	$wp_customize->add_control('vw_education_lite_button_text',array(
		'label'	=> __('Add Blog Button Text','vw-education-lite'),
		'input_attrs' => array(
	...
	//Selective Refresh
	$wp_customize->selective_refresh->add_partial( 'vw_education_lite_woocommerce_shop_page_sidebar', array( 'selector' => '.post-type-archive-product .sidebar', 
		'render_callback' => 'vw_education_lite_customize_partial_vw_education_lite_woocommerce_shop_page_sidebar', ) );
    ...
    //Selective Refresh
	$wp_customize->selective_refresh->add_partial( 'vw_education_lite_woocommerce_single_product_page_sidebar', array( 'selector' => '.single-product .sidebar', 
		'render_callback' => 'vw_education_lite_customize_partial_vw_education_lite_woocommerce_single_product_page_sidebar', ) );
