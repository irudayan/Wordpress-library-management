...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_education_lite_slider_hide_show', false) != '' || get_theme_mod( 'vw_education_lite_resp_slider_hide_show', false) != '') { ?>
    <section id="slider">
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" data-bs-interval="<?php echo esc_attr(get_theme_mod( 'vw_education_lite_slider_speed',4000)) ?>"> 
